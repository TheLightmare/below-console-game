// =============================================================================
// Hello World - Minimal Engine Starter Project
// =============================================================================
// Copy this folder to start a new project. Everything is set up and running:
//   - Window creation
//   - Input handling
//   - Camera with movement and zoom
...
int main(int argc, char* argv[]) {
    ...
    VkRenderer renderer;
    renderer.init("Hello World", WINDOW_W, WINDOW_H, /*fullscreen=*/false, /*validation=*/true);
    ...
    while (renderer.is_running()) {
        ...
        renderer.draw_text(ui_x, ui_y, "Hello World!", Color4::white(), 2.0f);
